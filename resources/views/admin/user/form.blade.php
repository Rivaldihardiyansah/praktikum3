            ...
            <div class="col-md-12">
                <form method="post" action="/store_user">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nik" placeholder="Nama Lengkap" name="nik">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="pob">Nama Lengkap</label>
                            <input type="text" class="form-control" id="name" placeholder="Tempat Kelahiran" name="name">
                        </div>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="addres" placeholder="Telp" name="addres">
                      </div>

                      <div class="form-group col-md-6">
                        <label for="telp">Nomer Telpon</label>
                        <input type="text" class="form-control" id="phone" placeholder="Telp" name="phone">
                      </div>

                      <div class="form-group col-md-6">
                        <label for="telp">Foto</label>
                        <input type="file" class="form-control" id="photo" placeholder="Telp" name="photo">
                      </div>
